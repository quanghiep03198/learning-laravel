<div class="relative z-50" role="dialog" aria-modal="true">
    <input type="checkbox" class="fixed inset-0 hidden peer" checked="false" id="drawer-toggler">

    <div
        class="fixed z-50 inset-0 flex transition ease-in-out duration-300 transform peer-checked:-translate-x-full translate-x-0 max-w-[20rem] w-full">
        <div class="relative mr-16 flex w-full max-w-xs flex-1">
            <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
                <label for="drawer-toggler" class="-m-2.5 p-2.5 cursor-pointer bg-white rounded-full shadow-sm">
                    <span class="sr-only">Close sidebar</span>
                    <svg class="h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div
                class="flex grow flex-col gap-y-5 overflow-y-auto h-screen bg-gray-900 px-6 pb-4 ring-1 ring-white/10 after:shadow-[9999px__0_0#03071280]">
                <div class="flex h-16 shrink-0 items-center">
                    <img class="h-8 w-auto" src="https://laravel.com/img/logomark.min.svg" alt="Your Company">
                </div>
